...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('botonPegar').onclick = function () {
        // Obtener el campo de texto
        navigator.clipboard.readText()
            .then(function(textoCopiado) {
                pasteText = textoCopiado;

                // Hacer algo con el texto (puedes mostrarlo en la consola o en otro lugar)
                console.log('Texto copiado:', textoCopiado);
                document.getElementById('input-text').value = pasteText;
            })
    ...
    // let fixedKey = getRandomKey(1000); 
